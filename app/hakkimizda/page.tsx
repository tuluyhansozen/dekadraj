    ...
    <section className="max-w-[1400px] mx-auto px-8 py-24">
      ...
      <div className="max-w-3xl mx-auto space-y-6 font-sans text-lg leading-relaxed text-ink/90">
        <p>
          ...
          sinemacılar ve sinema yazarları, sinemayı yalnızca anlatılan filmlerle
          değil, açtığı tartışmalar ve ürettiği karşı bakışlarla düşünmenin
        ...
        <p>
          ...
          hedefliyoruz. Sinemanın tarihini, endüstrisini ve toplumsal hafızasını
          yeniden düşünmenin; festivallerden dergilere, üretim ilişkilerinden
          devletle kurulan bağlara kadar bütünlüklü bir incelemenin gerektiğini
          düşünüyoruz.
        </p>
        ...
        <p>
          ...
          yollarını araştırır. Demokratik, eşit söz hakkına dayanan bir kolektif
          yapı içinde; sinemayı birlikte düşünen, üreten ve dönüştüren bir alan
